...
local MiniMapWidget = Class(Widget, function(self, mapscale)
    ...
    -- self.bg = self:AddChild(Image("images/minimap_paper.tex"))
    -- self.bg = self:AddChild(Image("images/options_bg.xml", "options_panel_bg.tex"))
...
function MiniMapWidget:ToggleBG(state)
	self.bgEnable = state
end
